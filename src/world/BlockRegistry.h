...
inline constexpr std::array<BlockColor,BLOCK_TYPE_COUNT> BLOCK_COLORS={{
  ...
  {51,153,26},{181,136,82},{142,95,52},{220,80,100},{105,108,112}
}};
inline constexpr std::array<const char*,BLOCK_TYPE_COUNT> BLOCK_NAMES={{
  "AIR","GRASS","DIRT","BEDROCK","STONE","COBBLESTONE","OAK LOG","SAND","GRAVEL","GLASS","LEAVES","PLANKS","CRAFTING TABLE","BED","FURNACE"
}};
