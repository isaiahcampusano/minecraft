...
private:
  ...
  void drawSky(const DayNightCycle&); void drawOutline(const RayHit&,const glm::mat4&,const glm::mat4&); void drawMiningCrack(const glm::ivec3&,float,const glm::mat4&,const glm::mat4&); void drawOverlay(int,int,const std::string&,const Inventory&);
};
