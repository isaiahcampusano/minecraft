...
public:
  ...
  void draw(const World&,const Player&,const PassiveMobSystem&,bool showPlayer,float deltaTime,const glm::mat4&,const glm::mat4&,const glm::vec3& camera,const RayHit&,int width,int height,const std::string& hud,const Inventory&,bool inventoryOpen,bool tableOpen,int creativePage,const DayNightCycle&);
private:
