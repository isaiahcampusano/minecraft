...
void Renderer::drawOverlay(int width,int height,const std::string& text,const Player& player,const Inventory& inventory,bool inventoryOpen,bool tableOpen,int creativePage){
